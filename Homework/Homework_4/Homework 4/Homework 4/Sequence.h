...
Sequence<ItemType>::Sequence(const Sequence<ItemType>& other)
{
    ...
    for (typename Sequence<ItemType>::Node* p = other.m_head->m_next; p != other.m_head; p = p->m_next)
...
bool Sequence<ItemType>::insert(int pos, const ItemType& value)
{
    ...
    typename Sequence<ItemType>::Node* p = nodeAtPos(pos);
...
int Sequence<ItemType>::insert(const ItemType& value)
{
    ...
    typename Sequence<ItemType>::Node* p;
    int pos;
...
int Sequence<ItemType>::remove(const ItemType& value)
{
    ...
    typename Sequence<ItemType>::Node* p = m_head->m_next;
    while (p != m_head)
    {
        if (p->m_value == value)
        {
...
void Sequence<ItemType>::swap(Sequence<ItemType>& other)
{
    ...
    typename Sequence<ItemType>::Node* p = other.m_head;
    other.m_head = m_head;
    m_head = p;
...
void Sequence<ItemType>::createEmpty()
{
    ...
    m_head = new typename Sequence<ItemType>::Node;
    m_head->m_next = m_head;
    m_head->m_prev = m_head;
}

template <typename ItemType>
void Sequence<ItemType>::insertBefore(typename Sequence<ItemType>::Node* p, const ItemType& value)
{
    // Create a new node
    
    typename Sequence<ItemType>::Node* newp = new typename Sequence<ItemType>::Node;
    newp->m_value = value;
...
template <typename ItemType>
typename Sequence<ItemType>::Node* Sequence<ItemType>::doErase(typename Sequence<ItemType>::Node* p)
{
    // Save pointer to p's successor
    
    typename Sequence<ItemType>::Node* pnext = p->m_next;
